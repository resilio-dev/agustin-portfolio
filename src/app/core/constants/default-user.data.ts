...
export const DEFAULT_USER_DATA: IUser = {
  ...
  skills: [
    ...
    },
    {
      id: 1,
      name: 'Python',
      skills: ['Fundamentos', 'Operadores', 'Análisis de Datos', 'Manejo de Excepciones', 'Estructuras de datos', 'Manejo de Archivos', 'POO'],
      urlLogo: 'assets/img/logos/language/python.svg',
      isLearning: false,
      type: 'LANGUAGE',
    },
    {
